import { o as objectType, h as dateType, n as numberType, i as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, j as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, b as renderTemplate, g as escape, k as renderUniqueStylesheet, l as renderScriptElement, p as createHeadAndContent, r as renderComponent, a as createAstro, d as addAttribute, q as renderScript, t as renderHead, v as renderSlot, m as maybeRenderHead } from './astro/server_CvpBhDpZ.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Dpj2CW0z.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Cgwx8c1l.mjs').then(n => n._);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/home/p0tchy/Documents/markpotaneblog/node_modules/.pnpm/astro@5.11.0_@types+node@24.0.13_jiti@2.4.2_lightningcss@1.30.1_rollup@4.44.2_typescript@5.8.3_yaml@2.8.0/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/p0tchy/Documents/markpotaneblog/node_modules/.pnpm/astro@5.11.0_@types+node@24.0.13_jiti@2.4.2_lightningcss@1.30.1_rollup@4.44.2_typescript@5.8.3_yaml@2.8.0/node_modules/astro/components/ClientRouter.astro", void 0);

const $$Astro$1 = createAstro();
const $$Head = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$Head;
  const { title = "Mark Edzel Potane", description } = Astro2.props;
  return renderTemplate`<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>${title}</title>${description && renderTemplate`<meta name="description"${addAttribute(description, "content")}>`}<meta name="generator"${addAttribute(Astro2.generator, "content")}>${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${renderHead()}</head>`;
}, "/home/p0tchy/Documents/markpotaneblog/src/components/Head.astro", void 0);
...
const $$MainLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Head", $$Head, { "title": title, "description": description, "data-astro-cid-ouamjn2i": true })} ${renderSlot($$result, $$slots["default"])} `;
}, "/home/p0tchy/Documents/markpotaneblog/src/layouts/MainLayout.astro", void 0);

const $$Nav = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<nav class="border-b border-gray-200"> <div class="container mx-auto max-w-2xl flex items-center justify-between px-4 py-4"> <a href="/" class="font-bold text-base">MP</a> <div class="flex gap-6 text-sm"> <a href="/" class="text-gray-600 hover:text-black transition-colors">Home</a> <a href="/#about" class="text-gray-600 hover:text-black transition-colors">About</a> <a href="/blog" class="text-gray-600 hover:text-black transition-colors">Blog</a> </div> </div> </nav>`;
}, "/home/p0tchy/Documents/markpotaneblog/src/components/Nav.astro", void 0);

export { $$MainLayout as $, $$Nav as a, getCollection as g, renderEntry as r };
